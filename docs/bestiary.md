...
Map datum: `MANIFEST_VERSION 2026-08-05.aggregate+glm+anova.v12` — the same
...
Security text scales badly. This project has 110 numbered hardening findings,
eleven decision records, 19 threats in the security model and 29 red-team
